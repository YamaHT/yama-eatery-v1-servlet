    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Product product : list) {
            stringPrint += " <tr class=\"table-of-product-body\">\n"
                    ...
                    + "                            <button type='button' onclick=\"changeManagement('product/update?id=" + product.getId() + "', 'Update product')\" class=\"table-of-product-body-button-update\">Update</button>\n"
                    + "                            <button type='button' onclick=\"changeManagement('product/delete?id=" + product.getId() + "', 'product')\" \n"
